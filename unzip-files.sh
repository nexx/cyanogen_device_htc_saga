...
unzip -j -o ../../../${DEVICE}_update.zip system/bin/snd8k -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
...
unzip -j -o ../../../${DEVICE}_update.zip system/lib/libcameraservice.so -d  ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
